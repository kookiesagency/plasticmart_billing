-- This migration updates the logging function to be more robust.
-- It correctly extracts the primary key for the target table, even if it's not named 'id'.
-- This fixes an issue where activities for the 'units' table were not being logged correctly.
...
BEGIN
  ...
  SELECT c.column_name INTO target_primary_key_column
